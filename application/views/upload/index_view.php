...
<head>
	...
	<noscript><link rel="stylesheet" href="<?= base_url('assets/jfu/css/jquery.fileupload-noscript.css'); ?>"></noscript>
	<noscript><link rel="stylesheet" href="<?= base_url('assets/jfu/css/jquery.fileupload-ui-noscript.css'); ?>"></noscript>
</head>
<body>
...
$('#fileupload')
    .bind('fileuploaddone', function (e, data) {console.log(data.files[0].name)});
</script>
<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE 8 and IE 9 -->
<!--[if (gte IE 8)&(lt IE 10)]>
<script src="<?= base_url('assets/jfu/js/cors/jquery.xdr-transport.js'); ?>"></script>
<![endif]-->
</body>
</html>
